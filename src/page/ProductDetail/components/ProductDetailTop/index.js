                ...
                <Row gutter={[{ md: 48 }]}>
                    ...
                    <Col xs={24} md={12}>
                        <div className={cx('details')}>
                            <h3 className={cx('title')}>{currentProduct?.name}</h3>
                            <div className={cx('rate')}>
                                <Evaluate
                                    rate={currentProduct?.ratings} // will fix it in the future
                                    countRate={currentProduct?.numOfReviews}
                                    isDisabled
                                />
                            </div>
                            ...
                            <span className={cx('categories')}>
                                Danh mục: {currentProduct?.category}
                            </span>
